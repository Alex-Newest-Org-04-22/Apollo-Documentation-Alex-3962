...
dataLayer.push({
  "event": "page_view",
  "detailed_event": "Page Load Started Alex",
    "page_data": {
        "countryAlex": "<countryAlex>",
        "language": "<language>",
        "name": "<name>",
        "page_location": "<page_location>",
        "site_nameAlex": "<site_nameAlex>",
        "site_type": "<site_type>"
    }
});
```
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|page_data.countryAlex|string|The country the site is associated with.||||||||
...
|page_data.site_nameAlex|string|Common language used within the business to refer to the website. May be specific County Sites.|Prospecting-EU, Prospecting-US, Member Portal, Shop-CA, Shop-US, Shop-EU|||||||
